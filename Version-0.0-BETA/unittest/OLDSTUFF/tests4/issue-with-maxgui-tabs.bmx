...
Function CreateDocument:TGadget(tabber:TGadget,content:String)
	Local textarea:TGadget
	textarea=CreateTextArea(0,0,ClientWidth(tabber),ClientHeight(tabber),tabber)
...
document[0]=CreateDocument(tabber, "DOC0")
document[1]=CreateDocument(tabber, "DOC1")
document[2]=CreateDocument(tabber, "DOC2")
