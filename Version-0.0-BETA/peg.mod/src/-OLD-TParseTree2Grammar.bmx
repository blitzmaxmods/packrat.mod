'
' This type uses a Visitor to construct GRAMMAR from a parse tree

Function ParseTree2Grammar:String( tree:TParseTree )
	DebugStop
	'Local visitor:IVisitor = New TParseTree2Grammar( tree )
	DebugStop
End Function

Type TParseTree2Grammar
