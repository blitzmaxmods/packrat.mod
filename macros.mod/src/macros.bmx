...
Function CHARSET:TPattern( set:String[] )
	Return New TCharset( set )
End Function
Function CHARSET:TPattern( set:Int[] )
	Return New TCharset( set )
End Function
Function CHARSET:TPattern( start:Int, finish:Int )
	Return New TCharset( start, finish )
End Function
...
' {error=message} - Error message and recovery pattern
Function ERROR:TPattern( message:String, pattern:TPattern )
	Return New TError( message, pattern )
End Function
...
' Depreciated, merges into CHARSET
...
Function SYMBOL:TPattern( character:Int )
	Return New TSymbol( character )
End Function
Function SYMBOL:TPattern( charset:Int[] )
